...
<div class="row no-gutters">
   ...
   <!---Primera columna de la primera fila-->
     ...
     $sql = "SELECT * FROM `publicaciones` WHERE tipo_panel = 'necesito' order by id_publicacion DESC limit 6,12;";
    ...
    <!--Card Narrower-->
                    <div class="card card-cascade narrower">
                        ...
                        <!--Card content-->
                        <div class="card-body">
                            <h5 class="pink-text"><?php echo getTipo_ayuda ($u['idCategoria']);?></h5>
                            <!--Title-->
    ...
    <!--/Fin de la tercer columna de la primer fila-->
...
<div class=" justify-content-end">
    ...
    <!-- Search form -->
        <form class="form-inline" method="get" action="search.php">
            <i class="fa fa-search"><input class="form-control mr-sm-5" type="text" placeholder="  Buscar nombre o zona" aria-label="Search"></i>
        </form>
...
<nav class="my-4">
    <ul class="pagination pagination-circle pg-blue mb-0">
        ...
        <!--First-->
        <li class="page-item"><a href="necesito.php" class="page-link">Primero</a></li>
        ...
        <!--Numbers-->
        <li class="page-item"><a href="necesito.php" class="page-link">1</a></li>
