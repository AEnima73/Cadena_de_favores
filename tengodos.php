...
<div class="row no-gutters ">
  <!-- Primer columna de tarjetas -->
   <?php
     ...
     $sql = "SELECT * FROM `publicaciones` WHERE tipo_panel = 'tengo' order by id_publicacion DESC limit 6,12;";
...
<nav class="my-4">
    <ul class="pagination pagination-circle pg-blue mb-0">
        ...
        <!--First-->
        <li class="page-item"><a href="tengo.php" class="page-link">Primero</a></li>
        ...
        <!--Numbers-->
        <li class="page-item"><a href="tengo.php" class="page-link">1</a></li>
